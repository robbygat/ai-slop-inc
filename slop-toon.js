(() => {
  ...
  class SlopToon {
    ...
    draw(timestamp) {
      ...
      const heroHeadroom = this.mode === 'hero' ? size * 0.08 : 0;
      const palette = this.skin.palette;
      ...
      const rect = {
        ...
        y: this.height / 2 - size * 0.38 + heroHeadroom - reaction * size * 0.02,
        w: size * 0.76,
        h: size * 0.79,
        cx: this.width / 2,
        cy: this.height / 2 + size * 0.012 + heroHeadroom - reaction * size * 0.02
      };
